...
<div class="row m-0 row-cols-1 row-cols-md-3 g-4">
    <div class="col">
      <div class="card h-100">
        <img src="{{ asset('template/assets/img/kamera/sonya7.jpg') }}" class="card-img-top rounded" alt="...">
        <div class="card-body">
    ...
    <div class="col">
        <div class="card h-100">
          <img src="{{ asset('template/assets/img/kamera/sonya6000.jpg') }}" class="card-img-top rounded" alt="...">
          <div class="card-body">
            <h5 class="card-title fw-bold pb-0 fs-5">Sony A6000</h5>
            <h6 class="card-subtitle mb-2 text-muted">Jogja Potret</h6>
            <p class="card-text mb-0">Kamera yang dikenal dapat menghasilkan gambar dengan resolusi tinggi di dalam kondisi cahaya minim ini sangat disukai banyak orang.</p>
            <p class="card-text"><small class="text-muted"><a href="">Detail</a></small></p>
          </div>
          <div class="card-footer">
    ...
    <div class="col">
        <div class="card h-100">
          <img src="{{ asset('template/assets/img/kamera/m6.jpg') }}" class="card-img-top rounded" alt="...">
          <div class="card-body">
    ...
    <div class="col">
        <div class="card h-100">
          <img src="{{ asset('template/assets/img/kamera/r6.jpg') }}" class="card-img-top rounded" alt="...">
          <div class="card-body">
