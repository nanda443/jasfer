...
<div class="row m-0 row-cols-1 row-cols-md-3 g-4">
    ...
    <div class="col">
        <div class="card h-100">
          ...
          <div class="card-body pb-0">
            ...
            <p class="card-text"><small class="text-muted"><a href="/fotografer/{{$fotografer->id}}">Detail</a></small></p>
          </div>
    ...
    <div class="col">
        <div class="card h-100">
          <img src="{{ asset('template/assets/img/messages-3.jpg') }}" class="card-img-top w-75 mx-auto mt-3 rounded-circle " alt="...">
          <div class="card-body pb-0">
